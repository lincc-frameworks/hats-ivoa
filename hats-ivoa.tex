...
As we add the data, t the point that the threshold is reached the data gets split into four higher-order HEALPix tiles using the spatial information contained in the data. 
