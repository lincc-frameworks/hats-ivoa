...
We use nested HEALPix tessellation technique extensively.
The full footprint of the catalog can alternatively be represented by a MOC, as it is a list of HEALPix pixels, at many different HEALPix orders
