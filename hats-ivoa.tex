...
In Figure~\ref{fig:exampleCollectionStructure}, we present an overview of this folder structure, including a few common examples of such optional catalogs.
...
\begin{verbatim}
    ...
    `-- [OPTIONAL] index_designation/
        ...
        `-- ...
    \end{verbatim}
    \caption{Example collection diretory contents}
    \label{fig:exampleCollectionStructure}
    \end{figure} 
...
hats\_cols\_sort &At catalog creation time, the columns used to sort the data, in addition to `healpix\_29` column. \\
...
\end{verbatim}
\end{center}
\caption{Example \texttt{properties} file contents}
\label{fig:examplePropertiesFile}
\end{figure}
...
\end{verbatim}
\end{center}
\caption{Example \texttt{partition\_info.csv} file contents}
\label{fig:examplePartitionInfoCsv}
\end{figure}
