...
File 1 contains less data, and it all fits into a single row group.
File 2 contains more data, and is split on disk into two row groups. 
...
The column statistics, however, will be different for every file, and some files may contain multiple statistics segments if the data inside a single file is very large and requires multiple row groups.
